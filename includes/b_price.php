    ...
    <div class="row-back center">
          ...
          <div class="w-col w-col-3  ">
            ...
            <div class="pricing-section">
              ...
              <div class="pricing-header">
                ...
                <span class="price"> Only $45 / Month</span>
              </div>
          ...
          <div class="w-col w-col-3 delay-1s">
            <div class="pricing-section">
              <div class="pricing-header">
                ...
                <span class="price">Only $300 / Month</span>
      ...
      <a href="#contact" class="button member" onclick="ga('send', 'event', 'button', 'Click', 'become member b');">Join today!</a>
